...
Element.prototype.remove = function() {
        ...
        if ("Element" in t) {
            ...
            if (s[n] = Error[n], l.item = function(t) {
                    ...
                    var t, e = arguments,
                        ...
                        r = e.length,
                        o = !1;
                    do t = e[n] + "", ~c(this, t) || (this.push(t), o = !0); while (++n < r);
                    ...
                    var t, e, n = arguments,
                        ...
                        i = !1;
                    do
                        for (t = n[r] + "", e = c(this, t); ~e;) this.splice(e, 1), i = !0, e = c(this, t); while (++r < o);
        ...
        function o(t, e) {
            try {
                ...
                if (e && ("object" == _typeof(e) || "function" == typeof e)) {
                    ...
                    if ("function" == typeof r) return void s(function(t, e) {
                        return function() {
                            t.apply(e, arguments)
                        }
                    }(r, e), t)
        ...
        }, n.prototype["finally"] = t, n.all = function(t) {
        ...
        function l(t, e) {
            ...
            if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new o(e.headers)), this.method = (n = e.method || this.method || "GET", r = n.toUpperCase(), b.indexOf(r) > -1 ? r : n), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && i) throw new TypeError("Body not allowed for GET or HEAD requests");
            this._initBody(i)
        }
        function d(t) {
            var e = new FormData;
        ...
        if (!t.fetch) {
            ...
            f.redirect = function(t, e) {
            ...
            }, t.Headers = o, t.Request = l, t.Response = f, t.fetch = function(t, e) {
                return new Promise(function(n, r) {
                    ...
                    a.onload = function() {
                        ...
                        r(new TypeError("Network request failed"))
                    }, a.open(i.method, i.url, !0), "include" === i.credentials ? a.withCredentials = !0 : "omit" === i.credentials && (a.withCredentials = !1), "responseType" in a && p.blob && (a.responseType = "blob"), i.headers.forEach(function(t, e) {
    ...
    function(t) {
        ...
        function o(t, e) {
            ...
            }, j = document.createElement("iframe"), j.setAttribute("style", "position:fixed;top:0;left:0;z-index:-1;border:none;opacity:0;pointer-events:none;width:100%;height:100%;"), j.setAttribute("allowTransparency", "true"), j.setAttribute("width", "100%"), j.setAttribute("height", "100%"), j.setAttribute("name", "checkout"), e ? (A = "loading", j.style.opacity = "0", j.style.pointerEvents = "none", j.style.zIndex = "-1", R = function() {
                E = !0, document.body.style.overflow = "hidden", j.style.opacity = "1", j.style.pointerEvents = "", j.style.zIndex = "2147483647"
            }, x = function() {
                E = !1, j.style.opacity = "0", j.style.pointerEvents = "none", j.style.zIndex = "-1", document.body.style.overflow = "", c()
            }) : (document.body.style.overflow = "", j.style.opacity = "1", j.style.pointerEvents = "", j.style.zIndex = "2147483647"), j.setAttribute("id", "flwpugpaidid"), j.src = "https://checkout.flutterwave.com/?", document.body && (document.querySelector("#flwpugpaidid") && document.querySelector("#flwpugpaidid").remove(), document.body.appendChild(j))
        }
        function i(t, e) {
            var n = {};
        ...
        function s(e, o) {
            w = document.getElementById("flwpugpaidid"), e.loadtimeout && n(e.onloadtimeout, e.loadtimeout), d = e;
            var i = JSON.parse(JSON.stringify(e));
            if (delete i.callback, delete i.onclose, delete i.onpaymentinit, delete i.onvalidateotpinit, delete i.meta, delete i.theme, delete i.billing, i.init_url = encodeURIComponent(t.location.href), t.location.href.includes("https://api.ravepay.co/flwv3-pug/getpaidx/api/hosted_pay/")) j.src = j.src + r(i);
                ...
                C ? a.postMessage({
                    name: "config",
                    configdata: r(i)
                }, "*") : (j = document.createElement("iframe"), j.setAttribute("style", "position:fixed;top:0;left:0;z-index:-1;border:none;opacity:0;pointer-events:none;width:100%;height:100%;"), j.setAttribute("allowTransparency", "true"), j.setAttribute("width", "100%"), j.setAttribute("height", "100%"), j.setAttribute("name", "checkout"), j.style.opacity = "1", j.style.pointerEvents = "", j.style.zIndex = "2147483647", document.body.style.overflow = "hidden", j.src = "https://checkout.flutterwave.com/?" + r(i), document.querySelector("#flwpugpaidid") && document.querySelector("#flwpugpaidid").remove(), document.body.appendChild(j))
            }
        }
        function c() {
            if (L)
                for (var e = 0; e < L; e++) {
                    ...
                    if (n) {
                        var r = {};
                        r = i(n, ["PBFPubKey", "txref", "amount", "customer_email", "customer_phone", "customer_lastname", "customer_firstname", "currency", "country", "customer_fullname", "callback", "onclose", "onvalidateotpinit", "onpaymentinit", "redirect_url", "pay_button_text", "custom_title", "custom_description", "custom_logo", "default_account", "payment_method", "exclude_banks", "settlement_token", "recurring_stop", "integrity_hash", "redirect_post", "redirect_no_json", "payment_page", "payment_plan", "campaign_id", "subaccounts_id", "subaccounts_transaction_charge_type", "subaccounts_transaction_split_ratio", "subaccounts_transaction_charge", "subaccounts", "payment_options", "disable_pwb", "hosted_payment", "mobilemoney_network"]), r.meta = a(n), r.subaccounts && (r.subaccounts = JSON.parse(r.subaccounts)), r.subaccounts_id && (r.subaccounts = [{
                            id: r.subaccounts_id,
                        ...
                        s.innerText = r.pay_button_text || "PAY NOW", n.innerText = "", s.setAttribute("style", "color:#fff;background-color:#0a2740;border-color:#142a3e;/*padding:10px;*/display:inline-block;padding:6px12px;margin-bottom:0;font-size:14px;font-weight:400;line-height:1.42857143;text-align:center;white-space:nowrap;vertical-align:middle;-ms-touch-action:manipulation;touch-action:manipulation;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-image:none;border:1pxsolidtransparent;border-radius:4px;"), s.setAttribute("type", "button"), s.addEventListener("click", function(e) {
        ...
        function l(t, e) {
            ...
            return o && (r.status = o.status, r.transaction_id = o.id, r.flw_ref = o.flwRef, r.amount = o.amount, r.currency = o.currency, r.customer = {
        ...
        var d, f, p, h, m, y, b, _, v, g, w, A = "none",
            E = !1,
            x = !1,
            T = function() {},
            k = null,
        ...
        B.cannotloadiframe = function(t) {
            ...
            C = !0, O = t.origin, t.source.postMessage({
                name: "updategotten",
                meta: p,
                subaccounts: h,
                theme: m,
        ...
        B.allcontentloaded = function(t) {
            ...
            clearTimeout(P), A = "loaded", E || T(), t.source.postMessage({
                name: "clickreport",
                time: _
            }, t.origin), k && document.getElementById("rve_spinner_container_0999") && document.body.removeChild(document.getElementById("rve_spinner_container_0999")), d && d.onopen && d.onopen(), d && d.onintegritycheck ? d.onintegritycheck(t.data.hash, e) : e()
        }, B.charge_complete = function(t) {
            C = !1, d && d.chargecomplete && d.chargecomplete(t.data.type, t.data.data)
        }, B.charge_init = function(t) {
            d && d.chargeinit && d.chargeinit(t.data.type, t.data.timestamp)
        }, B.opop = B.vbvcomplete = function(e) {
            C = !1, g && clearTimeout(g), d && (g = setTimeout(function() {
                ...
                "function" == typeof d.callback && (r && (r.redirectstatus = e.data && e.data.redirectstatus), d.callback(r))
            }))
        ...
        var R, I = document.querySelectorAll(".flwpug_getpaid"),
            L = I.length;
        c(), t.parseRedirectUrl = function(e) {
            if ("string" == typeof e) {
                var n = e.split("?"),
                    r = _toArray(n),
                    o = r[0],
                    i = r.slice(1);
                if (0 === o.indexOf("#")) return t.location.href.split("#")[0].concat(o).concat(i.length > 0 ? ";".concat(i.join("&")) : "")
            }
            return e
        }, t.addEventListener("beforeunload", function() {
            g && clearTimeout(g)
        }), t.FlutterwaveCheckout = function(t) {
            if (t = t && "object" === _typeof(t) && "error" === String(t.status).toLowerCase() ? t : u(t), f = t, f && !f.onclose && (f.onclose = function() {
                    var t = document.location;
                    return function() {
                        document.location = t
                    }
                }()), _ = Date.now(), 1 == t.hosted_payment && !t.is_hosted_page) {
                var e = document.createElement("form");
                e.setAttribute("method", "POST"), e.setAttribute("action", "https://checkout.flutterwave.com/hosted/pay");
                for (var n in t)
                    if ("meta" === n) t[n].forEach(function(t, r) {
                    ...
                    else if ("theme" === n || "billing" === n && "[object Object]" === Object.prototype.toString.call(t[n])) Object.keys(t[n]).forEach(function(r) {
                    var o = document.createElement("input");
                    o.setAttribute("type", "hidden"), o.setAttribute("name", n + "[" + r + "]"), o.setAttribute("value", t[n][r]), e.appendChild(o)
                });
                else if ("subaccounts" === n) t[n].forEach(function(t, r) {
                    var o = document.createElement("input");
            ...
            return v = t.is_hosted_page, delete t.is_hosted_page, p = t.meta, h = t.subaccounts, m = t.theme, y = t.billing, s(t), "loaded" == A ? R() : (k(), T = function() {
                R()
            }), {
